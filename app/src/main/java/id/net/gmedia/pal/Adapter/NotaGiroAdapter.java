...
public class NotaGiroAdapter extends RecyclerView.Adapter<NotaGiroAdapter.NotaGiroViewHolder> {
    ...
    public NotaGiroAdapter(List<SetoranModel> listSetoran, Activity activity){
    ...
    public NotaGiroViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new NotaGiroViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_setoran_sales, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull NotaGiroViewHolder setoranSalesViewHolder, final int i) {
