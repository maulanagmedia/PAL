package id.net.gmedia.pal.Activity.ActivityStok;
...
public class HistoryPengajuanStok extends AppCompatActivity {
    ...
    private HistoryPengajuanStokAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_history_pengajuan_stok);

        //Inisialisasi Toolbar
        if(getSupportActionBar() != null){
            getSupportActionBar().setTitle("History Pengajuan Stok");
    ...
    private void initUI() {
        ...
        adapter = new HistoryPengajuanStokAdapter(activity, listItem);
        ...
        lvHistory.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(activity, DetailPengajuanStokActivity.class);
    ...
    private void initData() {
        ...
        ApiVolleyManager.getInstance().addRequest(this, Constant.URL_GET_HISTORY_STOK + parameter, ApiVolleyManager.METHOD_GET,
