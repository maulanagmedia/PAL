...
public class DetailPengajuanStokActivity extends AppCompatActivity {
    ...
    private DetailPengajuanStokAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_pengajuan_stok);
    ...
    private void initUI() {
        ...
        adapter = new DetailPengajuanStokAdapter(activity, listItem);
    ...
    private void initData() {
        ...
        ApiVolleyManager.getInstance().addRequest(this, Constant.URL_GET_DETAIL_STOK + parameter, ApiVolleyManager.METHOD_GET,
