...
public class DetailPengajuanReturAdapter extends ArrayAdapter {

    private Activity context;
    private List<CustomItem> items;
    private ItemValidation iv = new ItemValidation();

    public DetailPengajuanReturAdapter(Activity context, List<CustomItem> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        DetailPengajuanReturAdapter.ViewHolder holder = new DetailPengajuanReturAdapter.ViewHolder();
        ...
        if(convertView == null){
            ...
            holder = (DetailPengajuanReturAdapter.ViewHolder) convertView.getTag();
        }
