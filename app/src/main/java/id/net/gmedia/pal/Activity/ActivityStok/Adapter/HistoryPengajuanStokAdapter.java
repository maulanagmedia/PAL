...
public class HistoryPengajuanStokAdapter extends ArrayAdapter {

    private Activity context;
    private List<CustomItem> items;
    private ItemValidation iv = new ItemValidation();

    public HistoryPengajuanStokAdapter(Activity context, List<CustomItem> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        HistoryPengajuanStokAdapter.ViewHolder holder = new HistoryPengajuanStokAdapter.ViewHolder();
        ...
        if(convertView == null){
            ...
            holder = (HistoryPengajuanStokAdapter.ViewHolder) convertView.getTag();
        }
