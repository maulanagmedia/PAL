...
public class PengajuanMutasiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengajuan_mutasi);

        setSupportActionBar((Toolbar) findViewById(R.id.toolbar));
        if(getSupportActionBar() != null){
            getSupportActionBar().setTitle("Pengajuan Mutasi");
        ...
        findViewById(R.id.btn_keterangan).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog = DialogFactory.getInstance().createDialog(PengajuanMutasiActivity.this,
        ...
        findViewById(R.id.btn_pengajuan).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(listBarang.size() < 1){
                    Toast.makeText(PengajuanMutasiActivity.this,
    ...
    private void pengajuan(){
        ...
        ApiVolleyManager.getInstance().addRequest(this, Constant.URL_PENGAJUAN_MUTASI,
                ...
                body.create(), new AppRequestCallback(new AppRequestCallback.RequestListener() {
                    ...
                    public void onEmpty(String message) {
                        Toast.makeText(PengajuanMutasiActivity.this, message, Toast.LENGTH_SHORT).show();
                        AppLoading.getInstance().stopLoading();
                    }

                    @Override
                    public void onSuccess(String result) {
                        Toast.makeText(PengajuanMutasiActivity.this, "Pengajuan berhasil dikirim", Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (getItem != null) {
            ...
            btn_tambah.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivityForResult(new Intent(PengajuanMutasiActivity.this,
                            PengajuanMutasiBarang.class), TAMBAH_BARANG);
                }
            });
        }
